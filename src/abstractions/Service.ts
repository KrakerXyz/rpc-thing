...
export type PromisfiedService<T extends Service<T>> = ExpandDeep<{ [K in keyof T]: T[K] extends (...args: infer TArgs) => infer TReturn ? (...args: TArgs) => PromiseWrap<TReturn> : PromisfiedService<T[K]> }>;